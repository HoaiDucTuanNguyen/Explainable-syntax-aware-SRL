...
class inferPipeline:
    ...
    def make_feature_samples(self, dataList, taskType, taskName):
        ...
        return allData
    def format_ner_output(self, sample, result, allScore):
        ...
        for sampleId in range(len(dataList)):
            ...
            for i in range(len(allIds)):
                ...
                if taskType == TaskType.NER:
                    ...
                    result = self.format_ner_output(inpp, result, allScores)
                else:
    ...
    def infer(self, dataList, taskNamesList, batchSize = 8, seed=42):
        ...
        with torch.no_grad():
            allIds, allPreds, allScores, allLogitsSigmoid,allSequenceOutput , allIndexGetFromMaxSeqLen = evaluate(allData, batchSampler, inferDataLoader, self.taskParams,
            ...
            return finalOutList, allLogitsSigmoid, allSequenceOutput, allIndexGetFromMaxSeqLen
