...
def make_arguments(parser):
    ...
    parser.add_argument('--freeze_shared_model', default=True, action='store_true',required=True,
    ...
    parser.add_argument('--load_saved_model', type=str, default=None,required=True,
                        help="path to the saved model in case of loading from saved")
    parser.add_argument('--eval_while_train', default = True, action = 'store_true',
                        help = "if evaluation on dev set is required during training.")
    parser.add_argument('--test_while_train', default=True, action = 'store_true',
    ...
    parser.add_argument('--finetune', default= True, action = 'store_true',required=True,
...
def main():
    ...
    if args.load_saved_model:
        # current_epoch = model.globalStep // (len(multiTaskDataLoaderTrain) // args.grad_accumulation_steps)
        if args.finetune is True:
