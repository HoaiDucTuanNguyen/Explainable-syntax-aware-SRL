...
def main():
    ...
    parser.add_argument('--has_labels', type=str, default=True,
    ...
    with torch.no_grad():
        ...
        evaluate(allData, batchSampler, inferDataLoader, taskParamsModel,
                model, gpu=torch.cuda.is_available(), evalBatchSize=args.eval_batch_size, needMetrics=True, hasTrueLabels=True,
